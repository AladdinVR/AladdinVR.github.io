...
# Deuxième mois :
On va se remettre au cardio tout en continuant la muscu. 
...
### Précisions du chef : 
* Le cardio est la partie la plus importante, ça vous servira pour le sprint. Donnez-vous à fond !
...
| Programme  | Faire 2 fois le circuit sans récup, 45 secondes de travail et 15 secondes de récup par exo : <ul><li> Abdos  </li><li> Mountain climbers </li><li> Gainage sur le dos en levant les jambes</li><li> Cercles avec les jambes (alterner le sens) </li><li> Levés de jambes </li><li> Touchés de chevilles </li></ul> | Faire le circuit 3 fois avec 2 mins de récup entre chaque : <ul><li> 40 fentes </li><li> 10 fentes sautées alternées </li><li> 30 squats </li><li> 5 squats sautés </li></ul> | Faire le circuit 10 fois avec 1 mins de recup entre chaque : <ul><li> 10 mountain climbers avec pompes </li><li> 20 planches croisées </li><li> 10 dips </li><li> 5 pompes sautées (si possible) </li></ul> | Faire entre 30 et 60 mins de running (allez-y en groupe) | 

### Précisions du chef : 
* Pour le touché de chevilles, garder le buste surélevé et avancer ses pieds assez loin pour que l'exercice soit dure ! 

* Pour les mountain climbers avec pompes : Partir d'une position de pompe, puis rapprocher le genou gauche du coude gauche pendant la descente. Faire de même à droite. 
